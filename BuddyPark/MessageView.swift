...
//    @AppStorage("Character") var currentCharacter: String = ""     // 直接把输入框的结果赋值存起来
//    @State private var showingModal = false
//    @StateObject var avatarUpdater = AvatarUpdater()
//    @State private var currentUser: User? = nil
//    @AppStorage("CharacterConfigCompleted") var characterConfigCompleted: Bool = false
//    @State private var showingSubscriptionView = false // 新增此行
//
//    var body: some View {
//        NavigationView {
//            VStack {
